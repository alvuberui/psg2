...
public class PetController {
	...
	private static final String VIEW = "redirect:/owners/{ownerId}";
    ...
    public String deleteVisitById(@PathVariable("visitId") int visitId) {
    	petService.deleteVisitById(visitId);
    	return VIEW;
    }
