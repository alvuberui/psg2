...
public interface OwnerRepository extends Repository<Owner, Integer> {
	...
	public void deleteOwner(@Param("id") int id);
	
	@Query(value = "SELECT O.id FROM Owners O JOIN Users U ON U.username=O.username WHERE O.username LIKE ?1", nativeQuery = true)	
	Integer findOwnerIdByUsername(String n);
