...
```
git clone https://github.com/gii-is-PSG2/spring-petclinic.git
cd spring-petclinic
./mvnw package
java -jar target/*.jar
```
...
Our issue tracker is available here: https://github.com/gii-is-PSG2/spring-petclinic/issues
...
|--------------------------|---|
|The Main Class | [PetClinicApplication](https://github.com/gii-is-PSG2/spring-petclinic/blob/master/src/main/java/org/springframework/samples/petclinic/PetClinicApplication.java) |
...
The [issue tracker](https://github.com/gii-is-PSG2/spring-petclinic/issues) is the preferred channel for bug reports, features requests and submitting pull requests.
